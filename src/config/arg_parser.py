...
def parse_args(args) -> argparse.Namespace:
    ...
    parser.add_argument('--epochs', action=EnvDefault, envvar='EPOCHS', type=int, default=50)
    ...
    parser.add_argument('--user_lr', action=EnvDefault, envvar='USER_LR', type=float, default=0.005)
    parser.add_argument('--item_lr', action=EnvDefault, envvar='ITEM_LR', type=float, default=0.001)
    parser.add_argument('--user_weight_decay', action=EnvDefault, envvar='USER_WEIGHT_DECAY', type=float, default=0.05)
    parser.add_argument('--item_weight_decay', action=EnvDefault, envvar='ITEM_WEIGHT_DECAY', type=float, default=0.1)
