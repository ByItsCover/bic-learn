...
from helpers.tensor_ops import process_user_id, process_item_id
...
class HotCoversDataSet(Dataset):
    ...
    def __getitem__(self, idx: int) -> tuple[Tensor, Tensor, Tensor, Tensor, Tensor, Tensor]:
        ...
        item_id_arr = torch.tensor(process_item_id(cover[self.id_field]))
...
class FeedbackDataSet(Dataset):
    ...
    def __getitem__(self, idx: int) -> tuple[Tensor, Tensor, Tensor, Tensor, Tensor, Tensor]:
        ...
        item_id_arr = torch.tensor(process_item_id(cover.cover_id))
